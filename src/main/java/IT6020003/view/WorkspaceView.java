...
public class WorkspaceView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (wsObject == null) {
			response.sendRedirect("/itad/HomeView?email="+email+"");
		} else {
			...
			out.append("                                    <form action=\"/itad/WorkspaceView?workspace_id="+wsObject.getWorking_space_id()+"&email="+email+"\" method=\"post\">");
