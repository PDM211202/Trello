...
public class PgObject {
	...
	public short getPg_delete() {
		return pg_delete;
	}

	public void setPg_delete(short pg_delete) {
	...
	public short getPg_enable() {
		return pg_enable;
	}

	public void setPg_enable(short pg_enable) {
	...
	public short getPg_language() {
		return pg_language;
	}

	public void setPg_language(short pg_language) {
