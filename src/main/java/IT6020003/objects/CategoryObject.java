...
public class CategoryObject {
    ...
    private short category_enable;
    private short category_delete;
	...
	public short getCategory_enable() {
		return category_enable;
	}

	public void setCategory_enable(short category_enable) {
		this.category_enable = category_enable;
	}

	public short getCategory_delete() {
		return category_delete;
	}

	public void setCategory_delete(short category_delete) {
