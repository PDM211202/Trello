...
public class ProductObject {
    ...
    private short product_enable;
    private short product_delete;
    ...
    private short product_is_detail;
    ...
    private short product_best_seller;
    private short product_promotion;
    private short product_price_calc_description;
    private String product_size;
    private String product_name_en;
    private int product_customer_id;
    private short product_perspective_id;
	...
	public short getProduct_enable() {
		return product_enable;
	}

	public void setProduct_enable(short product_enable) {
		this.product_enable = product_enable;
	}

	public short getProduct_delete() {
		return product_delete;
	}

	public void setProduct_delete(short product_delete) {
	...
	public short getProduct_is_detail() {
		return product_is_detail;
	}

	public void setProduct_is_detail(short product_is_detail) {
	...
	public short getProduct_best_seller() {
		return product_best_seller;
	}

	public void setProduct_best_seller(short product_best_seller) {
		this.product_best_seller = product_best_seller;
	}

	public short getProduct_promotion() {
		return product_promotion;
	}

	public void setProduct_promotion(short product_promotion) {
	...
	public short getProduct_perspective_id() {
		return product_perspective_id;
	}

	public void setProduct_perspective_id(short product_perspective_id) {
